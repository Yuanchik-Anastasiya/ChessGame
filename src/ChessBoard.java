public class ChessBoard {
    ...
    private void setupPieces() {
        ...
        // Place Queens
        board[0][3] = new Queens(PieceColor.BLACK, new Position(0, 3));
        board[7][3] = new Queens(PieceColor.WHITE, new Position(7, 3));

        // Place Kings
        board[0][4] = new Kings(PieceColor.BLACK, new Position(0, 4));
        board[7][4] = new Kings(PieceColor.WHITE, new Position(7, 4));

        // Place Pawns
        for (int i = 0; i < 8; i++) {
            board[1][i] = new Pawns(PieceColor.BLACK, new Position(1, i));
            board[6][i] = new Pawns(PieceColor.WHITE, new Position(6, i));
        }
